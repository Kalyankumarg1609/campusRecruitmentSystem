...
<!--- common page for Recruiters Actions --->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="sidebarCollapse">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="../view/Criteriapage.cfm" class="nav-link" id="vacancy" >
                            <i class="fa-regular fa-clipboard"></i> Company post
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../view/detalisSearch.cfm" class="nav-link" >
                            <i class="fa-solid fa-graduation-cap"></i> Students
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../view/interviewreports.cfm" class="nav-link" >
                            <i class="fa-solid fa-chart-simple"></i> Interview Reports
                        </a>
                    </li>
