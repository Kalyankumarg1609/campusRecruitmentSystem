        ...
        <div class="container-fluid">
                ...
                <div class="dropdown">
                    ...
                    <a href="#" id="sidebarAvatar" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="avatar-parent-child">
                            ...
                            <img 
                            alt="<cfoutput>#getimg.image_name#</cfoutput>" 
                            src="<cfoutput>#imagePath#</cfoutput>" class="avatar avatar- rounded-circle">
            ...
            <div class="collapse navbar-collapse" id="sidebarCollapse">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="../view/CampusinterviewSchedule.cfm" class="nav-link" id="schedule">
                            <i class="fa-regular fa-clipboard"></i> Interview Schedule
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../view/Analysispage.cfm" class="nav-link" 
                        id="reports">
                        ...
                        <a class="nav-link d-flex align-items-center">
                            ...
                            <div>
                                <span class="d-block text-sm font-semibold">
                                    <cfoutput>#session.stLoggedInUser.username#
                                    </cfoutput>
                                </span>
                            </div>
                        </a>
